...
- **Governed scope:** the set of governed repos is the manifest `governance/repos.json` in [qwts-agent-org](https://github.com/qwts/qwts-agent-org/blob/18ce9fd3d8d4df20e3846eb7c59c42e464a7cf9f/governance/repos.json) ([ENG-0011](docs/decisions/ENG-0011-governed-scope-manifest.md), [ENG-0355](docs/decisions/ENG-0355-static-router-one-pointer-pinned-capabilities.md)). Editing it is a reviewed PR in that repository, which regenerates its table and profile; nothing here reads or validates it.
